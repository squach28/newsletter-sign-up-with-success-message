...
const SuccessModal = (props) => {
  ...
  return (
    <div className="flex flex-col p-8 gap-6 justify-around bg-white rounded-md md:justify-normal md:max-w-md md:mx-auto md:shadow-lg">
        ...
        <button className="bg-[#242742] text-white p-4 rounded-md font-bold hover:bg-[#ff6257] hover:shadow-md hover:shadow-[#ff6257]" onClick={props.dismissModal}>Dismiss message</button>
    </div>
  )
}
